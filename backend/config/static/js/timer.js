...
const timer_name = document.querySelector("#timer_name")
const timer_duration = document.querySelector("#id_duration")
const timer_create = document.querySelector("#timer_create")
...
function finish() {
    timer_name.value =  timer_name.value || "Без имени"
    timer_duration.value = default_time
    timer_create.submit()
}
